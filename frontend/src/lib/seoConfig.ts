 ...
 * 
 * Title Length: 50-60 characters (optimal for Google/Bing display)
 * Description Length: 140-155 characters (optimal for search snippets)
 */
...
export const seoConfig: Record<string, SEOConfig> = {
    ...
    homepage: {
        ...
        description: 'Access SAU previous year questions, study notes & AI tutor. Browse 160+ courses across Agricultural Economics, Agriculture & ASVM at Sher-e-Bangla Agricultural University.',
    ...
    questions: {
        ...
        description: 'Browse SAU exam questions by faculty, level, semester & course. Access question papers for Agricultural Economics, Agriculture & ASVM with instant AI tutor support.',
    ...
    studyMaterials: {
        ...
        description: 'Download SAU textbooks, lecture notes & PDFs. Organized by faculty, level, semester & course for Agricultural Economics, Agriculture & ASVM students.',
    ...
    aiTutor: {
        ...
        description: 'Get instant help from SAU AI Tutor powered by Llama 4. Ask questions about Agricultural Economics, Agriculture or ASVM. Upload images for analysis & get answers.',
    ...
    sauQuestionBankPdf: {
        ...
        description: 'Download complete SAU question bank PDF collection for 2026. Includes previous year questions for Agricultural Economics, Agriculture & ASVM faculties. Free PDF download.',
    ...
    sauEconomicsQuestion: {
        ...
        description: 'Browse SAU Agricultural Economics (AEC) questions. Access Level-1 to Level-4 exam papers covering Micro/Macro Economics, Econometrics & Agribusiness Management.',
    ...
    sauAgricultureQuestion: {
        ...
        description: 'Access SAU Agriculture questions covering agronomy, entomology, soil science, plant pathology & crop production. Level-1 to Level-4 exam papers for agriculture students.',
    ...
    sauAsvmQuestion: {
        ...
        description: 'Browse SAU ASVM (Animal Science & Veterinary Medicine) questions. Access Level-1 to Level-5 exam papers covering anatomy, physiology, pathology & veterinary medicine.',
    ...
    sauNotes: {
        ...
        description: 'Download free SAU lecture notes & study guides for all faculties. Organized by course, level & semester. Includes Agricultural Economics, Agriculture & ASVM materials.',
    ...
    sauAdmissionPreparation: {
        ...
        description: 'Complete SAU admission preparation guide for 2026. Access previous year admission test questions, study materials & preparation tips for all SAU programs.',
